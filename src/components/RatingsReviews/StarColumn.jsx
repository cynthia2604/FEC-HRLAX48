    ...
    <>
      ...
      <div className="pt-2">
        <div className="cP" onClick={() => props.handleStarClick(5)}>
          ...
          <progress className="w-75" id="5star" value={Number(props.productMeta.ratings["5"]) || 0} max={total}></progress>
        </div>
        <div className="cP" onClick={() => props.handleStarClick(4)}>
          <label htmlFor="4star" className="pe-1">4 Stars:</label>
          <progress className="w-75" id="4star" value={Number(props.productMeta.ratings["4"]) || 0} max={total}></progress>
        </div>
        <div className="cP" onClick={() => props.handleStarClick(3)}>
          <label htmlFor="3star" className="pe-1">3 Stars:</label>
          <progress className="w-75" id="3star" value={Number(props.productMeta.ratings["3"]) || 0} max={total}></progress>
        </div>
        <div className="cP" onClick={() => props.handleStarClick(2)}>
          <label htmlFor="2star" className="pe-1">2 Stars:</label>
          <progress className="w-75" id="2star" value={Number(props.productMeta.ratings["2"]) || 0} max={total}></progress>
        </div>
        <div className="cP" onClick={() => props.handleStarClick(1)}>
          <label htmlFor="1star" className="pe-1">1 Stars:</label>
          <progress className="w-75" id="1star" value={Number(props.productMeta.ratings["1"]) || 0} max={total}></progress>
        </div>
      </div>
    </>
  )
