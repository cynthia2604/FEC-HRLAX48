...
export default function RatingsAndReviews(props) {
  ...
  const halfStar = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star-half" viewBox="0 0 16 16">
  ...
  function starRating(rating) {
    if (!rating) {
      ...
      return (
        <div>
          {filledStar}{emptyStar}{emptyStar}{emptyStar}{emptyStar}
        </div>
      )
    } else if (rating === 2) {
      return (
        <div>
          {filledStar}{filledStar}{emptyStar}{emptyStar}{emptyStar}
        </div>
      )
    } else if (rating === 3) {
      return (
        <div>
          {filledStar}{filledStar}{filledStar}{emptyStar}{emptyStar}
        </div>
      )
    } else if (rating === 4) {
      return (
      ...
      return (
        <div>
          {filledStar}{halfStar}{emptyStar}{emptyStar}{emptyStar}
        </div>
      )
    } else if (rating === 2.5) {
      return (
        <div>
          {filledStar}{filledStar}{halfStar}{emptyStar}{emptyStar}
        </div>
      )
    } else if (rating === 3.5) {
      return (
        <div>
          {filledStar}{filledStar}{filledStar}{halfStar}{emptyStar}
        </div>
      )
    } else if (rating === 4.5) {
      return (
        <div>
          {filledStar}{filledStar}{filledStar}{filledStar}{halfStar}
        </div>
      )
    }
  }
