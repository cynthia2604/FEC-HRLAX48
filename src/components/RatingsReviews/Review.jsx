      ...
      return (
        <div className='reviewRecommended'>
          <svg
            ...
            width='22'
            height='22'
            fill={props.darkTheme ? 'white' : 'black'}
            className='bi bi-check2'
            viewBox='0 0 16 16'
          >
            <path d='M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z' />
          </svg>
          <span className='ps-2'>I recommend this product</span>
        </div>
      );
    }
  }
    ...
    axios
      ...
      .then(() => {
        ...
        props.setSnackMessage(
          "Thank you for your report, you shouldn't see this review anymore"
        );
      ...
      <div className='review'>
        <div className='reviewTop'>
          <div className='reviewStars'>
            {props.darkTheme
              ? props.starRatingWhite(props.review.rating)
        ...
        <div className='reviewBody'>
          ...
          {showMore === 250 && props.review.body.length > 250 && (
            <p
              style={authorStyle}
              className='cP reviewBodyShowMore pt-2'
              onClick={() => setShowMore(999)}
            >
              Show More...
            </p>
          )}
